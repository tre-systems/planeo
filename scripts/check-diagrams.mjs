...
const tempDir = mkdtempSync(join(tmpdir(), "planeo-diagrams-"));
...
// byte-compared: Graphviz + libcairo emit different bytes across versions,
// which would produce stale-PNG false positives on every push. The .dot
// sources are the source of truth; PNGs are for in-browser viewing.
try {
