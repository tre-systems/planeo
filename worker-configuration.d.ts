/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1d3c82222d1a61066cf90893aa08ca59)
// Runtime types generated with workerd@1.20260601.1 2026-06-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	...
	AI_AGENTS_CONFIG: "";
	WORLD_WRITE_TOKEN: "";
	RATE_LIMIT_TTS_HOURLY: "240";
	RATE_LIMIT_AI_HOURLY: "2000";
	NEXTJS_ENV: string;
	GOOGLE_AI_API_KEY: string;
	GOOGLE_APP_CREDS_JSON: string;
	EVENT_HUB: DurableObjectNamespace<import("./worker").EventHub>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUMBER_OF_BOXES" | "TOTAL_AGENTS" | "AI_AGENTS_CONFIG" | "WORLD_WRITE_TOKEN" | "RATE_LIMIT_TTS_HOURLY" | "RATE_LIMIT_AI_HOURLY" | "NEXTJS_ENV" | "GOOGLE_AI_API_KEY" | "GOOGLE_APP_CREDS_JSON">> {}
}
